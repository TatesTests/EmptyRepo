...
*/
    ...
    r("Promise", function (a) {
        ...
        b.prototype.l = function () {
            function g(l) { return function (n) { k || (k = !0, l.call(h, n)) } }
        ...
        b.prototype.then = function (g, h) {
            function k(t, p) { return "function" == typeof t ? function (x) { try { l(t(x)) } catch (A) { n(A) } } : p }
        ...
        b.all = function (g) {
            var h = u(g), k = h.next(); return k.done ? d([]) : new b(function (l, n) {
    ...
    ; function zc() {
        function a() { e[0] = 1732584193; e[1] = 4023233417; e[2] = 2562383102; e[3] = 271733878; e[4] = 3285377520; n = l = 0 }
        function b(q) {
    ...
    function Oc() {
        ...
        if ("undefined" !== typeof a && !H("Trident") && !H("MSIE")) {
            var b = new a, c = {}, d = c; b.port1.onmessage = function () { if (void 0 !== c.next) { c = c.next; var e = c.la; c.la = null; e() } };
            return function (e) { d.next = { la: e }; d = d.next; b.port2.postMessage(0) }
    ...
    function xf(a, b) {
        var c = b.format || "JSON"; a = yf(a, b); var d = zf(a, b), e = !1, f = Af(a, function (k) {
            if (!e) {
                e = !0; h && window.clearTimeout(h); a: switch (k && "status" in k ? k.status : -1) { case 200: case 201: case 202: case 203: case 204: case 205: case 206: case 304: var l = !0; break a; default: l = !1 }var n = null, q = 400 <= k.status && 500 > k.status, t = 500 <= k.status && 600 > k.status; if (l || q || t) n = Bf(a, c, k, b.convertToSafeHtml); if (l) a: if (k && 204 == k.status) l = !0; else {
                    switch (c) { case "XML": l = 0 == parseInt(n && n.return_code, 10); break a; case "RAW": l = !0; break a }l =
                        !!n
                } n = n || {}; q = b.context || z; l ? b.onSuccess && b.onSuccess.call(q, k, n) : b.onError && b.onError.call(q, k, n); b.onFinish && b.onFinish.call(q, k, n)
            }
    ...
    function hg(a, b, c) {
        var d = Wf; c = void 0 === c ? {} : c; var e = Math.round(R()), f = a.size; a = u(a); for (var g = a.next(); !g.done; g = a.next()) {
            var h = u(g.value); g = h.next().value; var k = h.next().value; h = bb({ context: ig(d.config_ || jg()) }); h.events = k; (k = bg[g]) && kg(h, g, k); delete bg[g]; g = "visitorOnlyApprovedKey" === g; lg(h, e, g); Q("send_beacon_before_gel") && window.navigator && window.navigator.sendBeacon && !c.writeThenSend && Mf("/generate_204"); mg(d, "log_event", h, {
    ...
    ; function ug(a) {
        a = Object.assign({}, a); delete a.Authorization; var b = Ic(); if (b) {
            var c = new bd; c.update(O("INNERTUBE_API_KEY", void 0)); c.update(b); b = c.digest(); c = 3; Ha(b); void 0 === c && (c = 0); if (!fc) { fc = {}; for (var d = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""), e = ["+/=", "+/", "-_=", "-_.", "-_"], f = 0; 5 > f; f++) { var g = d.concat(e[f].split("")); ec[f] = g; for (var h = 0; h < g.length; h++) { var k = g[h]; void 0 === fc[k] && (fc[k] = h) } } } c = ec[c]; d = Array(Math.floor(b.length / 3)); e = c[64] || ""; for (f = g = 0; g < b.length -
                2; g += 3) { var l = b[g], n = b[g + 1]; k = b[g + 2]; h = c[l >> 2]; l = c[(l & 3) << 4 | n >> 4]; n = c[(n & 15) << 2 | k >> 6]; k = c[k & 63]; d[f++] = "" + h + l + n + k } h = 0; k = e; switch (b.length - g) { case 2: h = b[g + 1], k = c[(h & 15) << 2] || e; case 1: b = b[g], d[f] = "" + c[b >> 2] + c[(b & 3) << 4 | h >> 4] + k + e }a.hash = d.join("")
        } return a
    }
    ...
    function Sg(a, b, c) {
        b = Mg(b); var d = a instanceof Error ? a : Error("Unexpected error: " + a); if (d instanceof V) return d; if ("QuotaExceededError" === d.name) return new V("QUOTA_EXCEEDED", { objectStoreNames: c, dbName: b }); if (dc && "UnknownError" === d.name) return new V("QUOTA_MAYBE_EXCEEDED", { objectStoreNames: c, dbName: b }); if ("InvalidStateError" === d.name && Rg.some(function (e) { return d.message.includes(e) })) return new V("EXECUTE_TRANSACTION_ON_CLOSED_DB", {
            objectStoreNames: c,
            dbName: b
        }); if ("AbortError" === d.name) return new V("UNKNOWN_ABORT", { objectStoreNames: c, dbName: b }, d.message); d.args = [{ name: "IdbError", kb: d.name, dbName: b, objectStoreNames: c }]; d.level = "WARNING"; return d
    }
    ...
    function dh(a, b, c, d) {
        return I(a, function f() {
            var g = this, h, k, l, n, q, t, p, x, A, v, K, P; return y(f, function (E) {
                switch (E.h) {
    ...
    function jh(a, b) {
        var c = new Promise(function (d, e) { try { Wg(b(a).then(function (f) { d(f) }), e) } catch (f) { e(f), a.abort() } });
    ...
    m.update = function (a) { return X(this.cursor.update(a)) }; function sh(a, b, c) {
        return new Promise(function (d, e) {
            function f() { t || (t = new ch(g.result, { closed: q })); return t }
            var g = void 0 !== b ? self.indexedDB.open(a, b) : self.indexedDB.open(a); var h = c.blocked, k = c.blocking, l = c.Qa, n = c.upgrade, q = c.closed, t; g.addEventListener("upgradeneeded", function (p) {
                try {
    ...
    vh.prototype.open = function () {
        function a() {
            return I(c, function g() {
                var h = this, k, l, n, q, t; return y(g, function (p) {
                    switch (p.h) {
        ...
        var c = this; if (!this.l) throw wh(this); if (this.h) return this.h; var d, e = {
            blocking: function (f) { f.close() },
            closed: b, Qa: b, upgrade: this.options.upgrade
        }; return this.h = d = a()
    }; var xh = new vh("YtIdbMeta", { ja: { databases: { X: 1 } }, upgrade: function (a, b) { b(1) && fh(a, "databases", { keyPath: "actualName" }) } });
    ...
    function Nh() {
        if (Mh) return Mh(); var a = {}; Mh = Lh({
            ja: (a.LogsRequestsStore = { X: 2 }, a.sapisid = { X: 2 }, a.SWHealthLog = { X: 3 }, a), wa: !1, upgrade: function (b, c, d) {
    ...
    function Qh() {
        return I(this, function b() {
            var c, d, e, f, g, h, k; return y(b, function (l) {
                if (1 == l.h) return c = { startTime: R(), transactionType: "YT_IDB_TRANSACTION_TYPE_READ" }, w(l, Nh().open(), 2); if (3 != l.h) return d = l.i, e = O("INNERTUBE_CONTEXT_CLIENT_NAME", 0), f = ["NEW", e, 0], g = ["NEW", e, R()], h = IDBKeyRange.bound(f, g), k = void 0, w(l, dh(d, ["LogsRequestsStore"], { mode: "readwrite", D: !0 }, function (n) {
                    return qh(eh(n, "LogsRequestsStore").index("newRequestV2"), { query: h, direction: "prev" }, function (q) {
        ...
        var b = this; return this.o ? this.o : this.o = new Promise(function (c) {
            return I(b, function e() {
                var f, g, h, k = this; return y(e, function (l) {
                    switch (l.h) {
                        case 1: return f = window.AbortController ? new window.AbortController : void 0, g = null === f || void 0 === f ? void 0 : f.signal, h = !1, ra(l, 2, 3), f && (k.B = lf(function () { f.abort() }, a || 2E4)), w(l, fetch("/generate_204", {
                            method: "HEAD",
                            signal: g
                        }), 5); case 5: h = !0; case 3: ta(l); k.o = void 0; k.B && nf(k.B); h !== k.i && (k.i = h, k.i && k.l ? Td(k, "ytnetworkstatus-online") : k.l && Td(k, "ytnetworkstatus-offline")); c(h); va(l); break; case 2: sa(l), h = !1, l.v(3)
                    }
                })
            })
        })
    };
    Y.prototype.sendNetworkCheckRequest = Y.prototype.L; Y.prototype.listen = Y.prototype.ca; Y.prototype.enableErrorFlushing = Y.prototype.Da; Y.prototype.getWindowStatus = Y.prototype.ga; Y.prototype.monitorNetworkStatusChange = Y.prototype.Oa; Y.prototype.isNetworkAvailable = Y.prototype.J; Y.getInstance = $h; function ci(a) {
    ...
    ; var ei = 0, fi = 0, gi, hi = z.ytNetworklessLoggingInitializationOptions || { isNwlInitialized: !1, isIdbSupported: !1, potentialEsfErrorCounter: fi }; Q("export_networkless_options") && D("ytNetworklessLoggingInitializationOptions", hi); function ii(a, b) {
        function c(d) {
            var e = ji().J(); if (!ki() || !d || e && Q("vss_networkless_bypass_write")) li(a, b); else {
                var f = { url: a, options: b, timestamp: R(), status: "NEW", sendCount: 0 }; Oh(f).then(function (g) { f.id = g; (ji().J() || Q("networkless_always_online")) && mi(f) }).catch(function (g) {
                    mi(f);
                    ji().J() ? Le(g) : Wh(g)
                })
            }
    ...
    function oi(a, b) {
        function c(d) {
            if (ki() && d) {
                ...
                li(e.url, e.options); Oh(e).then(function (h) { e.id = h; f && Th(e.id) }).catch(function (h) { ji().J() ? Le(h) : Wh(h) })
            } else li(a, b)
        }
        b = void 0 === b ? {} : b; Q("skip_is_supported_killswitch") ? Ch().then(function (d) { c(d) }) : c(ni())
    }
    ...
    function mg(a, b, c, d) {
        function e(t) {
            ...
            } try { t && d.retry && !d.sa.bypassNetworkless ? (g.method = "POST", !d.sa.writeThenSend && Q("nwl_send_fast_on_unload") ? oi(q, g) : ii(q, g)) : (g.method = "POST", g.postParams || (g.postParams = {}), xf(q, g)) } catch (v) {
    ...
    ; function si(a, b) {
        var c = void 0 === c ? {} : c; var d = ri; O("ytLoggingEventsDefaultDisabled", !1) && ri == ri && (d = null); c = void 0 === c ? {} : c; var e = {}, f = Math.round(c.timestamp || R()); e.eventTimeMs = f < Number.MAX_SAFE_INTEGER ? f : 0; e[a] = b; a = B("_lact", window); a = null == a ? -1 : Math.max(Date.now() - a, 0); e.context = { lastActivityMs: String(c.timestamp || !isFinite(a) ? -1 : a) }; Q("log_sequence_info_on_gel_web") && c.va && (a = e.context, b = c.va, ng[b] = b in ng ? ng[b] + 1 : 0, a.sequence = { index: ng[b], groupKey: b }, c.hb && delete ng[c.va]); (c.mb ? gg : cg)({
            endpoint: "log_event",
            payload: e, H: c.H, aa: c.aa
        }, d)
    }
    ; var ti = [{
        ia: function (a) { return "Cannot read property '" + a.key + "'" },
        da: {
        ...
        ia: function (a) { return "Cannot call '" + a.key + "'" },
        da: {
        ...
        ia: function (a) { return a.key + " is not defined" },
        da: { ReferenceError: [{ regexp: /(.*) is not defined/, groups: ["key"] }, { regexp: /Can't find variable: (.*)/, groups: ["key"] }] }
    }]; var vi = { K: [], I: [{ Aa: ui, weight: 500 }] }; function ui(a) { a = a.stack; return a.includes("chrome://") || a.includes("chrome-extension://") || a.includes("moz-extension://") }
    ...
    function Vi(a, b, c) {
        Wi || (Wi = {}, Ue(window, "message", function (d) { a: { if (d.origin === Z(a, "host") || a.i && d.origin === Z(a, "host").toString().replace(/^http:/, "https:")) { try { var e = JSON.parse(d.data) } catch (f) { e = void 0; break a } a.l = !0; a.i && !a.h && 0 === d.origin.indexOf("https:") && (a.h = !0); if (d = Wi[e.id]) d.s = !0, d.s && (G(d.o, d.sendMessage, d), d.o.length = 0), d.ka(e) } e = void 0 } return e }));
        Wi[c] = b
    }
    ...
    m.setup = function (a, b) {
        var c = document; if (a = "string" === typeof a ? c.getElementById(a) : a) if (c = "iframe" === a.tagName.toLowerCase(), b.host || (b.host = c ? Hb(a.src) : "https://www.youtube-nocookie.com"), this.i = new Ti(b), c || (b = bj(this, a), this.m = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.h = a, this.h.id || (this.h.id = "widget" + Ia(this.h)), Ni[this.h.id] = this, window.postMessage) {
            this.l = new M; cj(this); b = Z(this.i, "events"); for (var d in b) b.hasOwnProperty(d) && this.addEventListener(d, b[d]); for (var e in Pi) Pi.hasOwnProperty(e) &&
                $i(this, e)
        }
    };
                    ...
                    var d = void 0, e = v; d = void 0 === d ? {} : d; d.name = O("INNERTUBE_CONTEXT_CLIENT_NAME",
                        1); d.version = O("INNERTUBE_CONTEXT_CLIENT_VERSION", void 0); var f = d || {}; d = "WARNING"; d = void 0 === d ? "ERROR" : d; if (e) {
                            e.hasOwnProperty("level") && e.level && (d = e.level); if (Q("console_log_js_exceptions")) {
                                ...
                                g = void 0; var k = f, l = dd(e); f = l.message || "Unknown Error"; h = l.name || "UnknownError"; var n = l.stack || e.i || "Not available"; if (n.startsWith(h + ": " + f)) { var q = n.split("\n"); q.shift(); n = q.join("\n") } q = l.lineNumber || "Not available"; l = l.fileName || "Not available"; var t = 0; if (e.hasOwnProperty("args") && e.args && e.args.length) for (g = 0; g < e.args.length && !(t = Ci(e.args[g], "params." + g, k, t), 500 <= t); g++); else if (e.hasOwnProperty("params") && e.params) {
                                    var p = e.params; if ("object" === typeof e.params) for (g in p) {
                                        if (p[g]) {
                                            var x =
                                                "params." + g, A = Ei(p[g]); k[x] = A; t += x.length + A.length; if (500 < t) break
                                        }
                                    } else k.params = Ei(p)
                                } if (Ji.length) for (g = 0; g < Ji.length && !(t = Ci(Ji[g], "params.context." + g, k, t), 500 <= t); g++); navigator.vendor && !k.hasOwnProperty("vendor") && (k["device.vendor"] = navigator.vendor); g = { message: f, name: h, lineNumber: q, fileName: l, stack: n, params: k, sampleWeight: 1 }; f = Number(e.columnNumber); isNaN(f) || (g.lineNumber = g.lineNumber + ":" + f); if ("IGNORED" === e.level) e = 0; else a: {
                                    e = yi(); f = u(e.K); for (h = f.next(); !h.done; h = f.next())if (h = h.value,
                                        g.message && g.message.match(h.jb)) { e = h.weight; break a } e = u(e.I); for (f = e.next(); !f.done; f = e.next())if (f = f.value, f.Aa(g)) { e = f.weight; break a } e = 1
                                } g.sampleWeight = e; e = g; g = u(ti); for (f = g.next(); !f.done; f = g.next())if (f = f.value, f.da[e.name]) for (q = u(f.da[e.name]), h = q.next(); !h.done; h = q.next())if (l = h.value, h = e.message.match(l.regexp)) { e.params["params.error.original"] = h[0]; q = l.groups; l = {}; for (n = 0; n < q.length; n++)l[q[n]] = h[n + 1], e.params["params.error." + q[n]] = h[n + 1]; e.message = f.ia(l); break } e.params || (e.params = {});
                                g = yi(); e.params["params.errorServiceSignature"] = "msg=" + g.K.length + "&cb=" + g.I.length; e.params["params.serviceWorker"] = "false"; z.document && z.document.querySelectorAll && (e.params["params.fscripts"] = String(document.querySelectorAll("script:not([nonce])").length)); hb("sample").constructor !== fb && (e.params["params.fconst"] = "true"); window.yterr && "function" === typeof window.yterr && window.yterr(e); if (0 !== e.sampleWeight && !Fi.has(e.message)) {
                                    "ERROR" === d ? (zi.O("handleError", e), Q("record_app_crashed_web") && 0 ===
                                        Ii && 1 === e.sampleWeight && (Ii++, si("appCrashed", { appCrashType: "APP_CRASH_TYPE_BREAKPAD" })), Hi++) : "WARNING" === d && zi.O("handleWarning", e); if (Q("kevlar_gel_error_routing")) {
                                            g = d; l = e; b: { f = u(Ki); for (h = f.next(); !h.done; h = f.next())if (Gf(h.value.toLowerCase())) { f = !0; break b } f = !1 } if (f) f = void 0; else {
    ...
    }; function dj(a) { return (0 === a.search("cue") || 0 === a.search("load")) && "loadModule" !== a }
    ...
    function hj(a, b) {
        G(b, function (c) {
            this[c] || ("getCurrentTime" === c ? this[c] = function () { var d = this.playerInfo.currentTime; if (1 === this.playerInfo.playerState) { var e = (Date.now() / 1E3 - this.playerInfo.currentTimeLastUpdated_) * this.playerInfo.playbackRate; 0 < e && (d += Math.min(e, 1)) } return d } : dj(c) ? this[c] = function () {
                this.playerInfo = {};
                this.F = {}; aj(this, c, arguments); return this
            } : ej(c) ? this[c] = function () {
                var d = 0;
    ...
    "undefined" != typeof YTConfig && YTConfig.parsetags && "onload" != YTConfig.parsetags || Qi(); var jj = z.onYTReady; jj && jj(); var kj = z.onYouTubeIframeAPIReady; kj && kj(); var lj = z.onYouTubePlayerAPIReady; lj && lj();
}).call(this);